...
function _inherits（subClass，superClass）{if（typeof superClass！==“function”&& superClass！== null）{throw new TypeError（“Super expression必须为null或函数，而不是”+ typeof superClass）; } subClass.prototype =的Object.create（超&& superClass.prototype，{构造：{值：亚类中，可枚举：假，可写：真，可配置的：真}}）; if（superClass）Object.setPrototypeOf？Object.setPrototypeOf（subClass，superClass）：subClass .__ proto__ = superClass; }
            ...
            if（target！== undefined）{
                if（target &&（typeof target ==='undefined'？'undefined'：_ typeof（target））==='object'&& target.nodeType === 1）{
                    ...
                    if（this.action ==='cut'&&（target.hasAttribute（'readonly'）|| target.hasAttribute（'disabled'）））{
                        抛出新的错误（'无效的'目标“属性。你不能从具有”只读“或”禁用“属性的元素中删除文本'）;
                    }
